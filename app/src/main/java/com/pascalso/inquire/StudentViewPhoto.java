 ...
 */
public class StudentViewPhoto extends AppCompatActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_view_photo);
        try {
            drawImage();
    ...
    private void drawImage() throws ParseException {
        ...
        bitmapdata = Student.getImage().getData();
    ...
    private void commentClick() {
        ImageButton viewComment = (ImageButton)findViewById(R.id.comment);
